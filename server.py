...
def process_audio_text():
    ...
    transcription, word_complexities, readability_metrics, difficulties = (
        process_audio_and_text(audio_base64, original_text, BEST_MODEL_NAME)
    )
...
def process_audio_and_text(audio_base64, original_text, model_name):
    ...
    difficulties = []  # Implement as needed based on your project specifics

    return transcription, word_complexities, readability_metrics, difficulties
